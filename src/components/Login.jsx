      ...
      <div className="relative py-3 sm:max-w-md sm:mx-auto">
        ...
        <div className="relative px-6 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-10">
          <div className="max-w-md mx-auto">
            <h1 className="text-2xl font-semibold text-center">Log-in Form</h1>

            <div className="divide-y divide-gray-200">
              <form onSubmit={handleLogin} className="py-6 space-y-6 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <p className="text-center text-gray-600 text-sm">
                  Don't have an account? <Link to="/sign-up" className="text-blue-600 underline">Sign-up here</Link>
                </p>
